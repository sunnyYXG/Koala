...
//        CGSize stringSize = [string sizeWithFont:self.stringLabel.font constrainedToSize:CGSizeMake(200, 300)];
        ...
        CGSize stringSize = [string boundingRectWithSize:CGSizeMake(200, 300) options:options attributes:@{NSFontAttributeName : self.stringLabel.font } context:nil].size;
